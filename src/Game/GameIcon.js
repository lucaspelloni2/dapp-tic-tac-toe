...
const UsernameIcon = styled.svg`
  width: 17px;
  height: 17px;
  fill: white;
`;

const Web3Provider = styled.svg`
  width: 15px;
  height: 15px;
  fill: white;
`;

const AwardIcon = styled.svg`
  width: 15px;
  height: 15px;
  fill: white;
`;
...
const GameIcon = props => {
  switch (props.icon) {
    ...
    case 'fail':
      return (
        <FailIcon xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
          <path
            xmlns="http://www.w3.org/2000/svg"
    ...
    case 'address':
      return (
        <AddressIcon xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
    ...
    case 'username':
      return (
        <UsernameIcon xmlns="http://www.w3.org/2000/svg" viewBox="0 0 640 512">
    ...
    case 'web3provider':
      return (
        <Web3Provider xmlns="http://www.w3.org/2000/svg" viewBox="0 0 496 512">
    ...
    case 'award':
      return (
        <AwardIcon xmlns="http://www.w3.org/2000/svg" viewBox="0 0 576 512">
    ...
    case 'message':
      return (
        <MessageIcon xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
